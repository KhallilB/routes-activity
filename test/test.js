...
//Test JSON
it('should display a JSON GET', (done) => {
    chai.request(server)
        .get('/venues')
        .end((err, res) => {
            res.should.be.json;
...
//     });
//     // TEST CREATE
//     it('should create a SINGLE review om /reviews POST', (done) => {
//         chai.request(server)
//             .post('/reviews')
//             .send(sampleReview)
//             .end((err, res) => {
...
//         review.save((err, data) => {
//             chai.request(server)
//                 .put(`/reviews/${data.id}?_method=PUT`)
//                 .send({
...
//         review.save((err, data) => {
//             chai.request(server)
//                 .delete(`/reviews/${data.id}?_method=DELETE`)
//                 .end((err, res) => {
//                     res.should.have.status(200);
//                     res.should.be.html
//                     done();
